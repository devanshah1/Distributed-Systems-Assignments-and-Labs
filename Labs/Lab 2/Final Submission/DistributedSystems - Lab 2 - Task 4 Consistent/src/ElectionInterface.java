...
public interface ElectionInterface extends Remote 
{
    ...
    /**
     * The restore method is used to restore the HashMap that contains the raw
     * results for the election. This is called by the server, when it detects 
     * that it has crashed unexpectedly.
     * @throws RemoteException
     */
